'''
Entry 05/07/2024
This code is based on the runnig version of "GUI_4_Ctrl_v3.py".
...
class MainWindow(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        global t_buffer, L_IMU_buffer, R_IMU_buffer, BattVolt_buffer, L_motor_torque_buffer, R_motor_torque_buffer,\
            ...
            Cmd_text, M1_Slider, M1_Tab_Label
        ...
        M1_Tab_Label = QLabel("Motor 1")
        M1_Tab_Layout.addWidget(M1_Tab_Label)
        M1_Tab_Layout.addWidget(M1_Slider)
    ...
    def valuechange(self):
        ...
        size = M1_Slider.value()
        # M1_Tab_Label.setFont(QFont("Arial",size))
