...
class MainWindow(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        global t_buffer, M1_Pos_buffer, M2_Pos_buffer, M2_Pos_cmd_buffer, R_motor_torque_buffer,\
            M1_Pos_cmd_buffer, R_motor_torque_d_buffer, L_motor_angpos_buffer, R_motor_angpos_buffer,\
            t_0, t_minus_1,\
            tau_d, q_d,\
    ...
    def update_plot_data(self):
        global t_buffer, M1_Pos_buffer, M2_Pos_buffer, M1_Pos_cmd_buffer, M2_Pos_cmd_buffer,\
            R_motor_torque_d_buffer, L_motor_angpos_buffer, R_motor_angpos_buffer,\
            R_leg_IMU_angle, M1_Pos, M2_Pos,\
            L_motor_torque_desired, R_motor_torque_desired, t_teensy, L_motor_angpos, R_motor_angpos,\
            t_0, t_minus_1,\
            tau_d, q_d,\
            Connection_Flag, LogginButton_Flag,\
            csv_file_name, DataHeaders, t_0_teensy, pos_cmd, M1_pos_cmd, M2_pos_cmd
